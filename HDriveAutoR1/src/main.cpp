...
void auton1(){ //still need to add the intake and stacking
  moveForward(1.1,1,0,100); //move forward again to intake the cubes
  ...
  moveForwardCalibrated(0.3, 80, 20, 'e'); // walk towards to edges(don't go too much, since the vision sensor is not precise when close)
  moveForward(0.25, 1, 0, 70); //move forward touching the stacking place(smashing with the wall doesn't matter and actually helps align the robot)
